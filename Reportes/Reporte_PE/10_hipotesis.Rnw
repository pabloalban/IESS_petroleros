...
Conforme a los análisis presentados en la sección \ref{chp_infofinan:rentablidad}, se establece la 
...
La tasa de incremento anual del salario básico unificado se fijó en 2,5\% para el periodo de la valuación actuarial. El modelo empleado y las predicciones resultantes del salario básico unificado se encuentran en la tabla \ref{mod:iess_sbu_proy} y \ref{tab:iess_sbu_proy}, respectivamente.
...
variación, período 2019--2058, el detalle de los cálculos se encuentra en el capítulo \ref{chp_contexto}. 
